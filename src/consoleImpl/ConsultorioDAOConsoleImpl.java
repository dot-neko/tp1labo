...
public class ConsultorioDAOConsoleImpl implements MedicoDAO, PacienteDAO, TurnoDAO{
	...
	@Override
	public void CrearTurnosMedicos(int docmed, String turno, int docpac, int consultorio, int reservado)
			throws BusinessException {
		// TODO Auto-generated method stub
	...
	@Override
	public List<String> BuscarTurnos(int docmed, String turno, int docpac, int consultorio, int reservado)
			throws BusinessException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public void ReservaTurno(int docmed, String turno, int docpac, int consultorio, int reservado)
			throws BusinessException {
		// TODO Auto-generated method stub
